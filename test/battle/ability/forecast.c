...
SINGLE_BATTLE_TEST("Forecast transforms Castform in weather from an opponent's move")
{
    ...
    GIVEN {
        ...
        case MOVE_SNOWSCAPE:
            ...
            break;
        case MOVE_SANDSTORM:
            EXPECT_EQ(player->species, SPECIES_CASTFORM_SANDSTORM);
            break;
        }
    }
}
...
DOUBLE_BATTLE_TEST("Forecast transforms Castform in weather from a partner's move")
{
    ...
    GIVEN {
        ...
        case MOVE_SNOWSCAPE:
            ...
            break;
        case MOVE_SANDSTORM:
            EXPECT_EQ(playerLeft->species, SPECIES_CASTFORM_SANDSTORM);
            break;
        }
    }
}
...
DOUBLE_BATTLE_TEST("Forecast transforms all Castforms present in weather")
{
    ...
    GIVEN {
        ...
        case MOVE_SANDSTORM:
            EXPECT_EQ(playerLeft->species, SPECIES_CASTFORM_SANDSTORM);
            EXPECT_EQ(playerRight->species, SPECIES_CASTFORM_SANDSTORM);
            EXPECT_EQ(opponentLeft->species, SPECIES_CASTFORM_SANDSTORM);
            EXPECT_EQ(opponentRight->species, SPECIES_CASTFORM_SANDSTORM);
            break;
        }
    }
}
