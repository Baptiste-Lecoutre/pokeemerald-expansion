...
struct BattleStruct
{
    ...
    struct LostItem itemLost[MAX_BATTLERS_COUNT][PARTY_SIZE];  // Pokemon that had items consumed or stolen (two bytes per party member per side)
    ...
    u8 supersweetSyrup[MAX_BATTLERS_COUNT];
