...
#define B_LEVEL_CAP_TYPE                EXP_CAP_SOFT // [LEVEL_CAP_NONE, LEVEL_CAP_FLAG_LIST, LEVEL_CAP_VARIABLE] choose the method to derive the level cap
#define B_LEVEL_CAP_VARIABLE            LEVEL_CAP_VARIABLE // event variable used to derive level cap if B_LEVEL_CAP_TYPE is set to LEVEL_CAP_VARIABLE
...
#define B_EXP_RELATIVE_PARTY            FALSE // If set to true, mons will gain more or less experience depending on their level with respect to the average party level
