...
#define OW_ITEM_DESCRIPTION_FIRST_BAG   2   // show description when new in bag, even if previously obtained
#define OW_ITEM_DESCRIPTIONS_ALWAYS     3   // always show description
#define OW_SHOW_ITEM_DESCRIPTIONS       OW_ITEM_DESCRIPTION_FIRST_BAG    // If enabled, item descriptions/images will be shown when finding items.
