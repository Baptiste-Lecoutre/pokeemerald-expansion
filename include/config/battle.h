...
#define B_ANIM_ON_OPPONENT_FAINT        FALSE // If TRUE, opposing Pokémons to the one that faints do their animation and play their cries. Victory dance kind of stuff
