...
#define SPECIES_PIKACHU_SURFING                    SPECIES_URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX + 1
#define SPECIES_PIKACHU_FLYING                     SPECIES_URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX + 2
