...
#define RAID_BOSS_CAUGHT        (1 << 3)
#define RAID_CREATE_SHIELD      (1 << 4)
#define RAID_BREAK_SHIELD       (1 << 5)
#define RAID_RESHOW_SHIELD     (1 << 6)
#define RAID_HIDE_SHIELD       (1 << 7)
#define RAID_UPDATE_SHIELD     (RAID_RESHOW_SHIELD | RAID_HIDE_SHIELD) // update sprites by destroying and creating them
// no more bit available before turning the states to u16.
