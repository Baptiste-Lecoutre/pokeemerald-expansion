...
#define VAR_STARTER_REGION                               0x404E // VAR_UNUSED_0x404E
...
#define VAR_CYNTHIA_STATE                                0x4083 // Unused Var
...
#define VAR_DAYCARE_ADOPTION_SPECIALS                                0x409B // Unused Var
...
#define VAR_POKE_VIAL_CHARGES                            0x40DB // Number of uses left in the Poke Vial before it needs to be refilled
#define VAR_POKE_VIAL_MAX_CHARGES                        0x40DC // Max number of uses for the Poke Vial after each charge
...
#define VAR_UNUSED_DEXNAV_SPECIES                        0x40F7 // Registered dexnav species, now unused
