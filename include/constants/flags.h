...
#define FLAG_SYS_DEXNAV_SEARCH                      (SYSTEM_FLAGS + 0x21) // Unused Flag
#define FLAG_SHINY_CREATION                         (SYSTEM_FLAGS + 0x22) // Unused Flag
...
#define FLAG_SYS_DETECTOR_MODE                      (SYSTEM_FLAGS + 0x2E) // Unused Flag
