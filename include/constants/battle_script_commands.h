...
#define VARIOUS_GIVE_DROPPED_ITEMS                   161
#define VARIOUS_JUMP_IF_NO_BALLS                     162
#define VARIOUS_CATCH_RAID_BOSS                      163
#define VARIOUS_HIDE_HEALTHBOXES                     164
#define VARIOUS_DO_RAID_SHOCKWAVE                    165
