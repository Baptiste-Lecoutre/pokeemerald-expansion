...
#define VARIOUS_JUMP_IF_NO_BALLS                     152
#define VARIOUS_CATCH_RAID_BOSS                      153
#define VARIOUS_HIDE_HEALTHBOXES                     154
#define VARIOUS_DO_RAID_SHOCKWAVE                    155
