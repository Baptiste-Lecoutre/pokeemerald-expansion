...
#define VARIOUS_GIVE_DROPPED_ITEMS                   137
#define VARIOUS_JUMP_IF_NO_BALLS                     138
#define VARIOUS_CATCH_RAID_BOSS                      139
#define VARIOUS_HIDE_HEALTHBOXES                     140
#define VARIOUS_DO_RAID_SHOCKWAVE                    141
