...
#define SINGLES_Z_TRIGGER_POS_X_PRIORITY    (30)
#define SINGLES_Z_TRIGGER_POS_X_SLIDE       (14)
#define SINGLES_Z_TRIGGER_POS_Y_DIFF        (-4)
...
#define DOUBLES_Z_TRIGGER_POS_Y_DIFF        (-2)
