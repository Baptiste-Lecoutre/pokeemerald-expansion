...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(HIKER, "HIKER", 10, ITEM_POKE_BALL),
    ...
    TRAINER_CLASS(BIRD_KEEPER, "BIRD KEEPER", 8, ITEM_POKE_BALL),
    ...
    TRAINER_CLASS(EXPERT, "EXPERT", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(AQUA_ADMIN, "AQUA ADMIN", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(BLACK_BELT, "BLACK BELT", 8, ITEM_ULTRA_BALL),
    TRAINER_CLASS(AQUA_LEADER, "AQUA LEADER", 20, ITEM_MASTER_BALL),
    TRAINER_CLASS(HEX_MANIAC, "HEX MANIAC", 6, ITEM_POKE_BALL),
    TRAINER_CLASS(AROMA_LADY, "AROMA LADY", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(RUIN_MANIAC, "RUIN MANIAC", 15, ITEM_POKE_BALL),
    TRAINER_CLASS(INTERVIEWER, "INTERVIEWER", 12, ITEM_POKE_BALL),
    TRAINER_CLASS(TUBER_F, "TUBER", 1, ITEM_POKE_BALL),
    TRAINER_CLASS(TUBER_M, "TUBER", 1, ITEM_POKE_BALL),
    TRAINER_CLASS(LADY, "LADY", 50, ITEM_POKE_BALL),
    TRAINER_CLASS(BEAUTY, "BEAUTY", 20, ITEM_POKE_BALL),
    TRAINER_CLASS(RICH_BOY, "RICH BOY", 50, ITEM_POKE_BALL),
    TRAINER_CLASS(POKEMANIAC, "POKéMANIAC", 15, ITEM_POKE_BALL),
    TRAINER_CLASS(GUITARIST, "GUITARIST", 8, ITEM_POKE_BALL),
    TRAINER_CLASS(KINDLER, "KINDLER", 8, ITEM_POKE_BALL),
    TRAINER_CLASS(CAMPER, "CAMPER", 4, ITEM_POKE_BALL),
    TRAINER_CLASS(PICNICKER, "PICNICKER", 4, ITEM_POKE_BALL),
    TRAINER_CLASS(BUG_MANIAC, "BUG MANIAC", 15, ITEM_POKE_BALL),
    TRAINER_CLASS(PSYCHIC, "PSYCHIC", 6, ITEM_POKE_BALL),
    TRAINER_CLASS(GENTLEMAN, "GENTLEMAN", 20, ITEM_LUXURY_BALL),
    TRAINER_CLASS(ELITE_FOUR, "ELITE FOUR", 25, ITEM_ULTRA_BALL),
    TRAINER_CLASS(LEADER, "LEADER", 25, ITEM_POKE_BALL),
    TRAINER_CLASS(SCHOOL_KID, "SCHOOL KID"),
    TRAINER_CLASS(SR_AND_JR, "SR. AND JR.", 4, ITEM_POKE_BALL),
    TRAINER_CLASS(WINSTRATE, "WINSTRATE", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(POKEFAN, "POKéFAN", 20, ITEM_POKE_BALL),
    TRAINER_CLASS(YOUNGSTER, "YOUNGSTER", 4, ITEM_POKE_BALL),
    TRAINER_CLASS(CHAMPION, "CHAMPION", 50, ITEM_POKE_BALL),
    TRAINER_CLASS(FISHERMAN, "FISHERMAN", 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_DIVE_BALL : ITEM_LURE_BALL),
    TRAINER_CLASS(TRIATHLETE, "TRIATHLETE", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(DRAGON_TAMER, "DRAGON TAMER", 12, ITEM_POKE_BALL),
    TRAINER_CLASS(NINJA_BOY, "NINJA BOY", 3, ITEM_POKE_BALL),
    TRAINER_CLASS(BATTLE_GIRL, "BATTLE GIRL", 6, ITEM_POKE_BALL),
    TRAINER_CLASS(PARASOL_LADY, "PARASOL LADY", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(SWIMMER_F, "SWIMMER♀", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TWINS, "TWINS", 3, ITEM_POKE_BALL),
    TRAINER_CLASS(SAILOR, "SAILOR", 8, ITEM_POKE_BALL),
    TRAINER_CLASS(COOLTRAINER_2, "COOLTRAINER", 5, ITEM_ULTRA_BALL),
    TRAINER_CLASS(MAGMA_ADMIN, "MAGMA ADMIN", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(RIVAL, "{PKMN} TRAINER", 15, ITEM_POKE_BALL),
    TRAINER_CLASS(BUG_CATCHER, "BUG CATCHER", 4, ITEM_POKE_BALL),
    TRAINER_CLASS(PKMN_RANGER, "{PKMN} RANGER", 12, ITEM_POKE_BALL),
    TRAINER_CLASS(MAGMA_LEADER, "MAGMA LEADER", 20, ITEM_MASTER_BALL),
    TRAINER_CLASS(LASS, "LASS", 4, ITEM_POKE_BALL),
    TRAINER_CLASS(YOUNG_COUPLE, "YOUNG COUPLE", 8, ITEM_POKE_BALL),
    TRAINER_CLASS(OLD_COUPLE, "OLD COUPLE", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(SIS_AND_BRO, "SIS AND BRO", 3, ITEM_POKE_BALL),
    ...
    TRAINER_CLASS(TEAM_ROCKET, "TEAM ROCKET", 10, ITEM_POKE_BALL),
    TRAINER_CLASS(BOSS, "BOSS", 20, ITEM_MASTER_BALL),
};
