...
u8 BlitItemIconToWindow(u16 itemId, u8 windowId, u16 x, u16 y, void * paletteDest) {
    ...
    if (paletteDest)
    {
        ...
        Free(buffer);
//        LZDecompressWram(GetItemIconPalette(itemId), gItemIconDecompressionBuffer/*gDecompressionBuffer*/);
//        CpuFastCopy(gItemIconDecompressionBuffer/*gDecompressionBuffer*/, paletteDest, PLTT_SIZE_4BPP);
    }
    else
    {
