...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_CATCHRAIDMON]                         = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} is weak! Throw a Ball?"),
    ...
    [STRINGID_RAIDPKMNDISAPPEARED]                  = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} disappeared somewhere into the den…"),
