...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_RAIDSHIELDAPPEARED]                   = COMPOUND_STRING("A mysterious barrier appeared, protecting\n{B_OPPONENT_MON1_NAME} from attacks."),
    [STRINGID_RAIDSHIELDDISAPPEARED]                = COMPOUND_STRING("The mysterious barrier protecting\n{B_OPPONENT_MON1_NAME} disappeared!"),
    ...
    [STRINGID_BARRIERRESTOREDENERGY]                = COMPOUND_STRING("The barrier restored\n{B_OPPONENT_MON1_NAME}'s energy!"),
    [STRINGID_RAIDBOSSLOSTITSENERGY]                = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} broke its stance! It lost its energy!"),
    [STRINGID_DYNAMAXENERGYSURROUNDS]               = COMPOUND_STRING("Dynamax energy surrounds\n{B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_PKMNDROPPEDITEM]                      = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} dropped its {B_LAST_ITEM}!{WAIT_SE}"),
    [STRINGID_BAGISFULL]                            = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} dropped {B_LAST_ITEM}!{WAIT_SE}\pBut your bag is full!"),
    ...
    [STRINGID_MAYDEVONSCOPEUNVEILED]                = COMPOUND_STRING("May's Devon Scope unveiled\nthe Ghost's identity!"),
    [STRINGID_BRENDANDEVONSCOPEUNVEILED]            = COMPOUND_STRING("Brendan's Devon Scope unveiled\nthe Ghost's identity!"),
