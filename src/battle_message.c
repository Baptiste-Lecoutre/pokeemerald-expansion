...
static const u8 sText_GhostAppearedCantId[] = _("The Ghost appeared!\pDarn! The Ghost can't be ID'd!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_POKEFLUTECATCHY]                      = COMPOUND_STRING("{B_PLAYER_NAME} played the {B_LAST_ITEM}. Now, that's a catchy tune!"),
    ...
    [STRINGID_PKMNAPPEARSMASSIVE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} appears to be massive!"),
    [STRINGID_DYNAMAXENERGYGATHERED]                = COMPOUND_STRING("Dynamax Energy gathered around {B_PLAYER_NAME}!"),
    [STRINGID_RAIDSHIELDAPPEARED]                   = COMPOUND_STRING("A mysterious barrier appeared, protecting {B_OPPONENT_MON1_NAME} from attacks."),
    [STRINGID_RAIDSHIELDDISAPPEARED]                = COMPOUND_STRING("The mysterious barrier protecting {B_OPPONENT_MON1_NAME} disappeared!"),
    [STRINGID_CATCHRAIDMON]                         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is weak! Throw a Ball?"),
    [STRINGID_PKMNISTOOSTRONG]                      = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} is too strong!"),
    [STRINGID_PKMNNULLIFIEDOTHERS]                  = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} nullified the stat changes and abilities of other Pokémon!"),
    [STRINGID_PKMNFOCUSEDONOPPONENTS]               = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} became sharply focused on its opponents!"),
    [STRINGID_PKMNRESETSTATINCREASE]                = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} nullified the stat increases of its opponents!"),
    [STRINGID_PKMNRECOVEREDFROMNEGATIVE]            = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} recovered from its negative conditions!"),
    [STRINGID_PKMNSTOLETERACHARGE]                  = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} stole a charge of your Tera Orb!"),
    [STRINGID_PKMNEMITTEDWAVEOFENERGY]              = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} emitted a wave of Z-Energy!"),
    [STRINGID_PKMNCALMEDHEALEDITSELF]               = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} calmed itself and restored its energy!"),
    [STRINGID_MOVEPREVENTEDBYDYNAMAX]               = COMPOUND_STRING("The move was blocked by the power of Dynamax!"), // duplicate of STRINGID_MOVEBLOCKEDBYDYNAMAX
    [STRINGID_RAIDPKMNDISAPPEARED]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} disappeared somewhere into the den…"),
    [STRINGID_STORMSTARTEDBREWING]                  = COMPOUND_STRING("A storm started brewing above you."),
    [STRINGID_STORMGETTINGSTRONGER]                 = COMPOUND_STRING("The storm above you is getting stronger!"),
    [STRINGID_STORMGETTINGEVENSTRONGER]             = COMPOUND_STRING("The storm is growing even stronger!"),
    [STRINGID_STORMGETTINGTOOSTRONG]                = COMPOUND_STRING("The storm is getting too strong to withstand!"),
    [STRINGID_BLOWNOUTOFDEN]                        = COMPOUND_STRING("{B_PLAYER_NAME} was blown out of the den!"),
    [STRINGID_PKMNREMOVEDEFFECTSFROMSELF]           = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} removed negative effects from itself!"),
    [STRINGID_ENERGYGATHEREDAROUNDPKMN]             = COMPOUND_STRING("Energy has begun to gather around {B_OPPONENT_MON1_NAME}!"),
    [STRINGID_PKMNBROKEITSSTANCE]                   = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} succumbed to the onslaught and broke its stance!"),
    [STRINGID_RAIDNOTMUCHTIMELEFT]                  = COMPOUND_STRING("You can feel tremendous energy gathering! There isn't much time left!"),
    [STRINGID_RAIDPKMNRELEASEDENERGY]               = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} released its gathered energy!"),
    [STRINGID_BARRIERRESTOREDENERGY]                = COMPOUND_STRING("The barrier restored {B_OPPONENT_MON1_NAME}'s energy!"),
    [STRINGID_RAIDBOSSLOSTITSENERGY]                = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} broke its stance! It lost its energy!"),
    [STRINGID_DYNAMAXENERGYSURROUNDS]               = COMPOUND_STRING("Dynamax energy surrounds {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PLAYERTERAORBCHARGING]                = COMPOUND_STRING("{B_PLAYER_NAME}'s Tera Orb is storing energy!"),
    [STRINGID_PLAYERTERAORBCHARGED]                 = COMPOUND_STRING("{B_PLAYER_NAME}'s Tera Orb is fully charged!"),
    [STRINGID_PKMNGAINEDEXPSHARE]                   = COMPOUND_STRING("Your Pokémons gained Exp. Points!"),
    [STRINGID_PKMNDROPPEDITEM]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} dropped its {B_LAST_ITEM}!{WAIT_SE}"),
    [STRINGID_BAGISFULL]                            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} dropped {B_LAST_ITEM}!{WAIT_SE} But your bag is full!"),
    [STRINGID_NORUNNINGFROMTHISBATTLE]              = COMPOUND_STRING("No! There's no running from this battle!"),
    ...
    [STRINGID_DEVONSCOPEUNVEILED]                   = COMPOUND_STRING("The Devon Scope unveiled the Ghost's identity!"),
    [STRINGID_MAYDEVONSCOPEUNVEILED]                = COMPOUND_STRING("May's Devon Scope unveiled the Ghost's identity!"),
    [STRINGID_BRENDANDEVONSCOPEUNVEILED]            = COMPOUND_STRING("Brendan's Devon Scope unveiled the Ghost's identity!"),
    [STRINGID_GHOSTWASOPPONENT]                     = COMPOUND_STRING("The Ghost was {B_OPPONENT_MON1_NAME}!"),
    [STRINGID_SENDWHICHMONTOPC]                     = COMPOUND_STRING("Do you want {B_DEF_NAME} to join your party?"),
};
