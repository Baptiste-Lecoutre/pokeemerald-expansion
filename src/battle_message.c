...
static const u8 sText_BagIsFull[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} dropped {B_LAST_ITEM}!{WAIT_SE}\pBut your bag is full!\p");
static const u8 sText_PkmnAppearsMassive[] = _("{B_OPPONENT_MON1_NAME} appears to be massive!");
static const u8 sText_DynamaxEnergyGathered[] = _("Dynamax Energy gathered around {B_PLAYER_NAME}!");
static const u8 sText_RaidBarrierAppeared[] = _("A mysterious barrier appeared, protecting {B_OPPONENT_MON1_NAME} from attacks.");
static const u8 sText_RaidBarrierDisappeared[] = _("The mysterious barrier protecting\n{B_OPPONENT_MON1_NAME} disappeared!");
static const u8 sText_CatchRaidMon[] = _("{B_OPPONENT_MON1_NAME} is weak! Throw a Ball?");
static const u8 sText_PkmnIsTooStrong[] = _("{B_OPPONENT_MON1_NAME} is too strong!");
static const u8 sText_PkmnNullifiedOthers[] = _("{B_OPPONENT_MON1_NAME} nullified the stat changes and abilities of other Pokémon!");
static const u8 sText_PkmnFocusedOnOpponents[] = _("{B_OPPONENT_MON1_NAME} became sharply focused on its opponents!");
static const u8 sText_PkmnResetStatIncreases[] = _("{B_OPPONENT_MON1_NAME} nullified the stat increases of its opponents!");
static const u8 sText_PkmnRecoveredFromNegative[] = _("{B_OPPONENT_MON1_NAME} recovered from its negative conditions!");
static const u8 sText_PkmnStoleTeraCharge[] = _("{B_OPPONENT_MON1_NAME} stole a charge of your Tera Orb!");
static const u8 sText_PkmnEmittedWaveZEnergy[] = _("{B_OPPONENT_MON1_NAME} emitted a wave of Z-Energy!");
static const u8 sText_PkmnCalmedHealed[] = _("{B_OPPONENT_MON1_NAME} calmed itself and restored its energy!");
static const u8 sText_MovePreventedByDynamax[] = _("The move was blocked by the power of Dynamax!");
static const u8 sText_RaidPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} appeared!");
static const u8 sText_RaidPkmnDisappeared[] = _("{B_OPPONENT_MON1_NAME} disappeared somewhere into the den...");
static const u8 sText_RaidPkmnGettingDesperate[] = _("{B_OPPONENT_MON1_NAME} is getting desperate! Its attacks are growing more aggressive!");
...
static const u8 sText_StormIsGettingTooStrong[] = _("The storm is getting too strong to withstand!");
static const u8 sText_BlownOutOfDen[] = _("{B_PLAYER_NAME} was blown out of the den!");
static const u8 sText_PkmnRemovedEffectsFromSelf[] = _("{B_OPPONENT_MON1_NAME} removed negative\neffects from itself!");
static const u8 sText_EnergyGatheredAroundPkmn[] = _("Energy has begun to gather around {B_OPPONENT_MON1_NAME}!");
static const u8 sText_PkmnBrokeItsStance[] = _("{B_OPPONENT_MON1_NAME} succumbed to the onslaught and broke its stance!");
static const u8 sText_RaidNotMuchTimeLeft[] = _("You can feel tremendous energy gathering! There isn't much time left!");
static const u8 sText_RaidPkmnReleasedEnergy[] = _("{B_OPPONENT_MON1_NAME} released its gathered energy!");
static const u8 sText_BarrierRestoredEnergy[] = _("The barrier restored\n{B_OPPONENT_MON1_NAME}'s energy!");
static const u8 sText_RaidBossLostItsEnergy[] = _("{B_OPPONENT_MON1_NAME} broke its stance! It lost its energy!");
static const u8 sText_PlayerTeraOrbCharging[] = _("{B_PLAYER_NAME}'s Tera Orb is storing energy!");
static const u8 sText_PlayerTeraOrbCharged[] = _("{B_PLAYER_NAME}'s Tera Orb is fully charged!");
static const u8 sText_DynamaxEnergySurroundsPkmn[] = _("Dynamax energy surrounds\n{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_NoRunningFromThisBattle[] = _("No! There's no running from this battle!\p");
...
static const u8 sText_DevonScopeUnveil[] = _("Devon Scope unveiled the Ghost's identity!");
...
static const u8 sText_SendWhichMonToPC[] = _("Do you want {B_DEF_NAME} to join your party?");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNGAINEDEXPSHARE - BATTLESTRINGS_TABLE_START] = sText_PkmnGainedEXPShare,
