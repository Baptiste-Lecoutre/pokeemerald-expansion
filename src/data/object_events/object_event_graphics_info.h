...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_DawnNormal = {TAG_NONE, OBJ_EVENT_PAL_TAG_DAWN, OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION, 512, 32, 32, 0, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_BrendanMayNormal, sPicTable_DawnNormal, gDummySpriteAffineAnimTable};
