...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = { // rustboro gym
    {
    .iv = 100,
    .lvl = 10,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Tommy[] = { // rustboro gym
    {
    .iv = 110,
    .lvl = 10,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Marc[] = { // rustoro gym
    {
    .iv = 120,
    .lvl = 10,
...
static const struct TrainerMonNoItemCustomMoves sParty_BrendanRustboroTreecko[] = {
    ...
    .lvl = 14,
    .species = SPECIES_TAILLOW,
    .moves = {MOVE_GUST, MOVE_QUICK_ATTACK, MOVE_GROWL, MOVE_REFRESH}
    },
    {
    .iv = 25,
    .lvl = 14,
    ...
    .lvl = 15,
    .species = SPECIES_COMBUSKEN,
    .moves = {MOVE_DOUBLE_KICK, MOVE_ROCK_TOMB, MOVE_EMBER, MOVE_PECK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BrendanRustboroMudkip[] = {
    ...
    .lvl = 14,
    .species = SPECIES_GROWLITHE,
    .moves = {MOVE_EMBER, MOVE_BITE, MOVE_REVERSAL, MOVE_ROAR}
    },
    {
    .iv = 50,
    .lvl = 15,
    .species = SPECIES_GROVYLE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_QUICK_ATTACK, MOVE_FURY_CUTTER, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BrendanRustboroTorchic[] = {
    {
    .iv = 25,
    .lvl = 14,
    .species = SPECIES_TAILLOW,
    ...
    .lvl = 15,
    .species = SPECIES_MARSHTOMP,
    .moves = {MOVE_MUD_SLAP, MOVE_WATER_GUN, MOVE_ROCK_TOMB, MOVE_GROWL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MayRustboroMudkip[] = {
    ...
    .lvl = 14,
    .species = SPECIES_STARYU,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_DEFENSE_CURL, MOVE_PSYWAVE, MOVE_SWIFT}
    },
    {
    .iv = 25,
    .lvl = 14,
    .species = SPECIES_PONYTA,
    .moves = {MOVE_EMBER, MOVE_TAIL_WHIP, MOVE_TACKLE, MOVE_DOUBLE_KICK}
    },
    {
    .iv = 50,
    .lvl = 15,
...
static const struct TrainerMonItemDefaultMoves sParty_CourtneyMagmaHideout[] = {
    {
    .iv = 150,
    .lvl = 62,
    .heldItem = ITEM_FIRE_GEM,
...
static const struct TrainerMonItemDefaultMoves sParty_CourtneyMossdeep[] = {
    {
    .iv = 150,
    .lvl = 68,
    .heldItem = ITEM_FIRE_GEM,
...
static const struct TrainerMonNoItemCustomMoves sParty_MayRustboroTreecko[] = {
    ...
    .lvl = 14,
    .species = SPECIES_STEENEE,
    .moves = {MOVE_RAZOR_LEAF, MOVE_CHARM, MOVE_ACUPRESSURE, MOVE_SPORE}
    },
    {
    .iv = 50,
    .lvl = 15,
...
static const struct TrainerMonItemDefaultMoves sParty_Misty[] = {
    {
    .iv = 50,
    .lvl = 22,
    .species = SPECIES_QUAGSIRE,
...
static const struct TrainerMonItemCustomMoves sParty_LtSurge[] = {
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_ELECTABUZZ,
...
static const struct TrainerMonItemCustomMoves sParty_RedFallarbor[] = {
    {
    .iv = 50,
    .lvl = 37,
    .heldItem = ITEM_LIGHT_BALL,
