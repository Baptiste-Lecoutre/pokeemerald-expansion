...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_LEADER_BROCK] = sAnims_May,
    [TRAINER_PIC_LEADER_MISTY] = sAnims_May,
    [TRAINER_PIC_LEADER_LT_SURGE] = sAnims_May,
    [TRAINER_PIC_LEADER_ERIKA] = sAnims_May,
    [TRAINER_PIC_LEADER_KOGA] = sAnims_May,
    [TRAINER_PIC_LEADER_SABRINA] = sAnims_May,
    [TRAINER_PIC_LEADER_BLAINE] = sAnims_May,
    [TRAINER_PIC_ROCKET_GRUNT_M] = sAnims_May,
    [TRAINER_PIC_ROCKET_GRUNT_F] = sAnims_May,
    [TRAINER_PIC_GIOVANNI] = sAnims_May,
    [TRAINER_PIC_CYNTHIA] = sAnims_May,
    [TRAINER_PIC_BLUE] = sAnims_May,
    [TRAINER_PIC_ETHAN] = sAnims_May,
    [TRAINER_PIC_LYRA] = sAnims_May,
    [TRAINER_PIC_KRIS] = sAnims_May,
    [TRAINER_PIC_LUCAS] = sAnims_May,
    ...
    [TRAINER_PIC_CHASE] = sAnims_May,
    [TRAINER_PIC_ELAINE] = sAnims_May,
};
