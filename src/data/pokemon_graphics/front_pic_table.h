const struct CompressedSpriteSheet gMonFrontPicTable[NUM_SPECIES + 1] =
{
    ...
    // Gigantamax Forms
    SPECIES_SPRITE(VENUSAUR_GMAX, gMonFrontPic_VenusaurGmax),
    SPECIES_SPRITE(CHARIZARD_GMAX, gMonFrontPic_CharizardGmax),
    SPECIES_SPRITE(BLASTOISE_GMAX, gMonFrontPic_BlastoiseGmax),
    SPECIES_SPRITE(BUTTERFREE_GMAX, gMonFrontPic_ButterfreeGmax),
    SPECIES_SPRITE(PIKACHU_GMAX, gMonFrontPic_PikachuGmax),
    SPECIES_SPRITE(MEOWTH_GMAX, gMonFrontPic_MeowthGmax),
    SPECIES_SPRITE(MACHAMP_GMAX, gMonFrontPic_MachampGmax),
    SPECIES_SPRITE(GENGAR_GMAX, gMonFrontPic_GengarGmax),
    SPECIES_SPRITE(KINGLER_GMAX, gMonFrontPic_KinglerGmax),
    SPECIES_SPRITE(LAPRAS_GMAX, gMonFrontPic_LaprasGmax),
    SPECIES_SPRITE(EEVEE_GMAX, gMonFrontPic_EeveeGmax),
    SPECIES_SPRITE(SNORLAX_GMAX, gMonFrontPic_SnorlaxGmax),
    SPECIES_SPRITE(GARBODOR_GMAX, gMonFrontPic_GarbodorGmax),
    SPECIES_SPRITE(MELMETAL_GMAX, gMonFrontPic_MelmetalGmax),
    SPECIES_SPRITE(RILLABOOM_GMAX, gMonFrontPic_RillaboomGmax),
    SPECIES_SPRITE(CINDERACE_GMAX, gMonFrontPic_CinderaceGmax),
    SPECIES_SPRITE(INTELEON_GMAX, gMonFrontPic_InteleonGmax),
    SPECIES_SPRITE(CORVIKNIGHT_GMAX, gMonFrontPic_CorviknightGmax),
    SPECIES_SPRITE(ORBEETLE_GMAX, gMonFrontPic_OrbeetleGmax),
    SPECIES_SPRITE(DREDNAW_GMAX, gMonFrontPic_DrednawGmax),
    SPECIES_SPRITE(COALOSSAL_GMAX, gMonFrontPic_CoalossalGmax),
    SPECIES_SPRITE(FLAPPLE_GMAX, gMonFrontPic_FlappleGmax),
    SPECIES_SPRITE(APPLETUN_GMAX, gMonFrontPic_AppletunGmax),
    SPECIES_SPRITE(SANDACONDA_GMAX, gMonFrontPic_SandacondaGmax),
    SPECIES_SPRITE(TOXTRICITY_GMAX, gMonFrontPic_ToxtricityGmax),
    SPECIES_SPRITE(CENTISKORCH_GMAX, gMonFrontPic_CentiskorchGmax),
    SPECIES_SPRITE(HATTERENE_GMAX, gMonFrontPic_HattereneGmax),
    SPECIES_SPRITE(GRIMMSNARL_GMAX, gMonFrontPic_GrimmsnarlGmax),
    SPECIES_SPRITE(ALCREMIE_GMAX, gMonFrontPic_AlcremieGmax),
    SPECIES_SPRITE(COPPERAJAH_GMAX, gMonFrontPic_CopperajahGmax),
    SPECIES_SPRITE(DURALUDON_GMAX, gMonFrontPic_DuraludonGmax),
    SPECIES_SPRITE(URSHIFU_GMAX, gMonFrontPic_UrshifuGmax),
    SPECIES_SPRITE(URSHIFU_RAPID_STRIKE_STYLE_GMAX, gMonFrontPic_UrshifuRapidStrikeGmax),
#endif
