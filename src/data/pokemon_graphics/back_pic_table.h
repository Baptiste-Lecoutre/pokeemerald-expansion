const struct CompressedSpriteSheet gMonBackPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(PIKACHU_SURFING, gMonBackPic_PikachuSurfing),
    SPECIES_SPRITE(PIKACHU_FLYING, gMonBackPic_PikachuFlying),
    ...
    SPECIES_SPRITE(URSHIFU_RAPID_STRIKE_STYLE_GMAX, gMonBackPic_UrshifuRapidStrikeGmax),
#endif
