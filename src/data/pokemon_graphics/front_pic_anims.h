...
PLACEHOLDER_ANIM_SINGLE_FRAME(LugiaPrimal);
...
#if P_PRIMAL_REVERSIONS
PLACEHOLDER_ANIM_SINGLE_FRAME(HoOhPrimal);
#endif //P_PRIMAL_REVERSIONS
...
#if P_PRIMAL_REVERSIONS
PLACEHOLDER_ANIM_SINGLE_FRAME(DialgaPrimal);
#endif //P_PRIMAL_REVERSIONS
...
#if P_PRIMAL_REVERSIONS
PLACEHOLDER_ANIM_SINGLE_FRAME(PalkiaPrimal);
#endif //P_PRIMAL_REVERSIONS
...
#if P_PRIMAL_REVERSIONS
SINGLE_ANIMATION(LugiaPrimal);
#endif //P_PRIMAL_REVERSIONS
#endif //P_FAMILY_LUGIA
#if P_FAMILY_HO_OH
SINGLE_ANIMATION(HoOh);
#if P_PRIMAL_REVERSIONS
SINGLE_ANIMATION(HoOhPrimal);
#endif //P_PRIMAL_REVERSIONS
#endif //P_FAMILY_HO_OH
#if P_FAMILY_CELEBI
