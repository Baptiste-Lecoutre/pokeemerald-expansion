...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(ROCKET_GRUNT_M, RocketGruntM, 0, 0, 0x200),
    TRAINER_SPRITE(ROCKET_GRUNT_F, RocketGruntF, 0, 0, 0x200),
    TRAINER_SPRITE(GIOVANNI, Giovanni, 0, 0, 0x200),
    TRAINER_SPRITE(CYNTHIA, Cynthia, 0, 0, 0x200),
    TRAINER_SPRITE(BLUE, Blue, 0, 0, 0x200),
    TRAINER_SPRITE(ETHAN, Ethan, 0, 0, 0x200),
    TRAINER_SPRITE(LYRA, Lyra, 0, 0, 0x200),
    TRAINER_SPRITE(KRIS, Kris, 0, 0, 0x200),
    TRAINER_SPRITE(LUCAS, Lucas, 0, 0, 0x200),
    TRAINER_SPRITE(DAWN, Dawn, 0, 0, 0x200),
    TRAINER_SPRITE(LUCAS_PLATINUM, LucasPlatinum, 0, 0, 0x200),
    TRAINER_SPRITE(DAWN_PLATINUM, DawnPlatinum, 0, 0, 0x200),
    TRAINER_SPRITE(MAGMA_ADMIN_F, MagmaAdminF, 0, 0, 0x200),
    TRAINER_SPRITE(CHASE, Chase, 0, 0, 0x200),
    TRAINER_SPRITE(ELAINE, Elaine, 0, 0, 0x200),
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(ETHAN, 4, Ethan, BackPicPalette_Ethan, Hoenn),
    TRAINER_BACK_SPRITE(LYRA, 4, Lyra, BackPicPalette_Lyra, Hoenn),
    TRAINER_BACK_SPRITE(KRIS, 4, Kris, BackPicPalette_Kris, Hoenn),
    TRAINER_BACK_SPRITE(LUCAS, 4, Lucas, BackPicPalette_Lucas, Hoenn),
    TRAINER_BACK_SPRITE(DAWN, 4, Dawn, BackPicPalette_Dawn, Hoenn),
    TRAINER_BACK_SPRITE(LUCAS_PLATINUM, 4, LucasPlatinum, BackPicPalette_LucasPlatinum, Hoenn),
