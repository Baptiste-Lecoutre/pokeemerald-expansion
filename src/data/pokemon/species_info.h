...
#define PIKACHU_MISC_INFO(gender, flip, type2)                                    \
        .baseHP        = 35,                                               \
        .baseAttack    = 55,                                               \
        .baseSpeed     = 90,                                               \
        .baseSpAttack  = 50,                                               \
        PIKACHU_BASE_DEFENSES,                                             \
        .types = { TYPE_ELECTRIC, type2},                                  \
        .catchRate = 190,                                                  \
        .expYield = 112,                                                   \
        .evYield_Speed     = 2,                                            \
...
#define COSPLAY_PIKACHU_SPECIES_INFO(flip, type2) { PIKACHU_MISC_INFO(MON_FEMALE, flip, type2) }
#define CAP_PIKACHU_SPECIES_INFO(flip, type2)     { PIKACHU_MISC_INFO(MON_MALE, flip, type2) }
...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_PIKACHU] = { PIKACHU_MISC_INFO(PERCENT_FEMALE(50), FLIP, TYPE_ELECTRIC) },
...
#define ALCREMIE_REGULAR_MISC_INFO(color, sweet, cream)                     \
    ...
    [SPECIES_PIKACHU_ROCK_STAR] = COSPLAY_PIKACHU_SPECIES_INFO(FLIP, TYPE_STEEL),
    ...
    [SPECIES_PIKACHU_PH_D]      = COSPLAY_PIKACHU_SPECIES_INFO(FLIP, TYPE_PSYCHIC),
    [SPECIES_PIKACHU_LIBRE]     = COSPLAY_PIKACHU_SPECIES_INFO(FLIP, TYPE_FIGHTING),
    [SPECIES_PIKACHU_SURFING]   = COSPLAY_PIKACHU_SPECIES_INFO(FLIP, TYPE_WATER),
    [SPECIES_PIKACHU_FLYING]    = COSPLAY_PIKACHU_SPECIES_INFO(FLIP, TYPE_FLYING),

    [SPECIES_PIKACHU_ORIGINAL_CAP] = CAP_PIKACHU_SPECIES_INFO(NO_FLIP, TYPE_ELECTRIC),
    [SPECIES_PIKACHU_HOENN_CAP]    = CAP_PIKACHU_SPECIES_INFO(FLIP, TYPE_ELECTRIC),
    [SPECIES_PIKACHU_SINNOH_CAP]   = CAP_PIKACHU_SPECIES_INFO(FLIP, TYPE_ELECTRIC),
    [SPECIES_PIKACHU_UNOVA_CAP]    = CAP_PIKACHU_SPECIES_INFO(FLIP, TYPE_ELECTRIC),
    [SPECIES_PIKACHU_KALOS_CAP]    = CAP_PIKACHU_SPECIES_INFO(FLIP, TYPE_ELECTRIC),
    [SPECIES_PIKACHU_ALOLA_CAP]    = CAP_PIKACHU_SPECIES_INFO(FLIP, TYPE_ELECTRIC),
    [SPECIES_PIKACHU_PARTNER_CAP]  = CAP_PIKACHU_SPECIES_INFO(NO_FLIP, TYPE_ELECTRIC),
    [SPECIES_PIKACHU_WORLD_CAP]    = CAP_PIKACHU_SPECIES_INFO(FLIP, TYPE_ELECTRIC),
    ...
    {
        PIKACHU_MISC_INFO(PERCENT_FEMALE(50), FLIP, TYPE_ELECTRIC),
        .gigantamax = TRUE,
    },
