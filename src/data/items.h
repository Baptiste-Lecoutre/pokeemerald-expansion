...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM52_FOCUS_BLAST] =
    {
        .name = _("TM52"),
        .price = 3000,
        .description = COMPOUND_STRING("Attacks at full\n"
                                       "power. May also\n"
                                       "lower Sp Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM53_ENERGY_BALL] =
    {
        .name = _("TM53"),
        .price = 3000,
        .description = COMPOUND_STRING("Draws power from\n"
                                       "nature to attack.\n"
                                       "May lower Sp Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM55_SCALD] =
    {
        .name = _("TM55"),
        .price = 3000,
        .description = COMPOUND_STRING("Shoots boiling water\n"
                                       "at the foe. May\n"
                                       "inflict a burn."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM57_CHARGE_BEAM] =
    {
        .name = _("TM57"),
        .price = 3000,
        .description = COMPOUND_STRING("Fires a beam of\n"
                                       "electricity.\n"
                                       "May raise Sp. Atk."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM58_ENDURE] =
    {
        .name = _("TM58"),
        .price = 3000,
        .description = COMPOUND_STRING("Endures any attack\n"
                                       "for 1 turn, leaving\n"
                                       "at least 1HP."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM61_WILL_O_WISP] =
    {
        .name = _("TM61"),
        .price = 3000,
        .description = COMPOUND_STRING("Inflicts a burn on\n"
                                       "the foe with\n"
                                       "intense fire."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM62_ACROBATICS] =
    {
        .name = _("TM62"),
        .price = 3000,
        .description = COMPOUND_STRING("Does double damage\n"
                                       "if the user has\n"
                                       "no held item."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM65_SHADOW_CLAW] =
    {
        .name = _("TM65"),
        .price = 3000,
        .description = COMPOUND_STRING("Slashes with a claw\n"
                                       "of shadows. High\n"
                                       "critical-hit ratio."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM67_RECYCLE] =
    {
        .name = _("TM67"),
        .price = 3000,
        .description = COMPOUND_STRING("Recycles a used\n"
                                       "held item for one\n"
                                       "more use."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM69_ROCK_POLISH] =
    {
        .name = _("TM69"),
        .price = 3000,
        .description = COMPOUND_STRING("Polishes the body\n"
                                       "to sharply raise\n"
                                       "speed."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM70_AURORA_VEIL] =
    {
        .name = _("TM70"),
        .price = 3000,
        .description = COMPOUND_STRING("Weakens all attacks,\n"
                                       "but only usable\n"
                                       "with hail."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM71_STONE_EDGE] =
    {
        .name = _("TM71"),
        .price = 3000,
        .description = COMPOUND_STRING("Stabs the foe with\n"
                                       "sharp stones. High\n"
                                       "critical-hit ratio."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM72_VOLT_SWITCH] =
    {
        .name = _("TM72"),
        .price = 3000,
        .description = COMPOUND_STRING("Does damage then\n"
                                       "switches out the\n"
                                       "user."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM73_THUNDER_WAVE] =
    {
        .name = _("TM73"),
        .price = 3000,
        .description = COMPOUND_STRING("A weak jolt of\n"
                                       "electricity that\n"
                                       "paralyzes the foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM74_GYRO_BALL] =
    {
        .name = _("TM74"),
        .price = 3000,
        .description = COMPOUND_STRING("A high-speed spin\n"
                                       "that hurts faster\n"
                                       "foes more."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM75_SWORDS_DANCE] =
    {
        .name = _("TM75"),
        .price = 3000,
        .description = COMPOUND_STRING("A fighting dance\n"
                                       "that sharply raises\n"
                                       "Attack."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM76_STEALTH_ROCK] =
    {
        .name = _("TM76"),
        .price = 3000,
        .description = COMPOUND_STRING("A sneaky trap of\n"
                                       "stones that hurt\n"
                                       "a foe switching in."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM77_STRUGGLE_BUG] =
    {
        .name = _("TM77"),
        .price = 3000,
        .description = COMPOUND_STRING("Resisting, the user\n"
                                       "attacks the foes.\n"
                                       "Lowers Sp. Atk."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM79_FREEZE_DRY] =
    {
        .name = _("TM79"),
        .price = 3000,
        .description = COMPOUND_STRING("Super effective on\n"
                                       "Water-types. May\n"
                                       "cause freezing."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM81_X_SCISSOR] =
    {
        .name = _("TM81"),
        .price = 3000,
        .description = COMPOUND_STRING("Slashes foe with\n"
                                       "crossed scythes,\n"
                                       "claws, etc."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM82_DRAGON_TAIL] =
    {
        .name = _("TM82"),
        .price = 3000,
        .description = COMPOUND_STRING("Knocks the foe\n"
                                       "away to end the\n"
                                       "battle."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM83_FLAME_CHARGE] =
    {
        .name = _("TM83"),
        .price = 3000,
        .description = COMPOUND_STRING("Attacks in a cloak\n"
                                       "of flames. Raises\n"
                                       "the user's Speed."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM84_POISON_JAB] =
    {
        .name = _("TM84"),
        .price = 3000,
        .description = COMPOUND_STRING("A stabbing attack\n"
                                       "that may poison\n"
                                       "the foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM85_DREAM_EATER] =
    {
        .name = _("TM85"),
        .price = 3000,
        .description = COMPOUND_STRING("Heals for half the\n"
                                       "damage inflicted on\n"
                                       "a sleeping foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM86_GRASS_KNOT] =
    {
        .name = _("TM86"),
        .price = 3000,
        .description = COMPOUND_STRING("A snare attack that\n"
                                       "does more damage\n"
                                       "to heavier foes."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM87_SMACK_DOWN] =
    {
        .name = _("TM87"),
        .price = 3000,
        .description = COMPOUND_STRING("Throws a rock to\n"
                                       "knock the foe to\n"
                                       "the ground."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM88_LOW_SWEEP] =
    {
        .name = _("TM88"),
        .price = 3000,
        .description = COMPOUND_STRING("Attacks the foe's\n"
                                       "legs, lowering its\n"
                                       "Speed."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM90_SUBSTITUTE] =
    {
        .name = _("TM90"),
        .price = 3000,
        .description = COMPOUND_STRING("Creates a decoy\n"
                                       "using 1/4 of the\n"
                                       "user's maximum HP."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM91_FLASH_CANNON] =
    {
        .name = _("TM91"),
        .price = 3000,
        .description = COMPOUND_STRING("Releases a blast\n"
                                       "of light that may\n"
                                       "lower Sp. Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM92_TRICK_ROOM] =
    {
        .name = _("TM92"),
        .price = 3000,
        .description = COMPOUND_STRING("Slower Pokémon get\n"
                                       "to move first for\n"
                                       "five turns."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM93_WILD_CHARGE] =
    {
        .name = _("TM93"),
        .price = 3000,
        .description = COMPOUND_STRING("An electric charge\n"
                                       "attack that also\n"
                                       "hurts the user."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM94_SUCKER_PUNCH] =
    {
        .name = _("TM94"),
        .price = 3000,
        .description = COMPOUND_STRING("Strikes first if\n"
                                       "the foe is readying\n"
                                       "an attack."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM95_SNARL] =
    {
        .name = _("TM95"),
        .price = 3000,
        .description = COMPOUND_STRING("Yells and rants at\n"
                                       "the foe, lowering\n"
                                       "its Sp. Atk."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM97_DARK_PULSE] =
    {
        .name = _("TM97"),
        .price = 3000,
        .description = COMPOUND_STRING("Releases a horrible\n"
                                       "aura that may cause\n"
                                       "flinching."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM99_DAZZLING_GLEAM] =
    {
        .name = _("TM99"),
        .price = 3000,
        .description = COMPOUND_STRING("Damages foes by\n"
                                       "emitting a bright\n"
                                       "flash."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
