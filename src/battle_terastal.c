...
#define SINGLES_TERA_TRIGGER_POS_X_OPTIMAL (29)
#define SINGLES_TERA_TRIGGER_POS_X_PRIORITY (30)
#define SINGLES_TERA_TRIGGER_POS_X_SLIDE (14)
#define SINGLES_TERA_TRIGGER_POS_Y_DIFF (-4)

#define DOUBLES_TERA_TRIGGER_POS_X_OPTIMAL (29)
#define DOUBLES_TERA_TRIGGER_POS_X_PRIORITY (30)
#define DOUBLES_TERA_TRIGGER_POS_X_SLIDE (14)
#define DOUBLES_TERA_TRIGGER_POS_Y_DIFF (-2)
