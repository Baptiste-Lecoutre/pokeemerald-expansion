...
static const u8 sDoorAnimPalettes_Gym[] = {0, 0, 0, 0, 0, 0, 0, 0};
...
static const u8 sDoorAnimPalettes_Oldale[] = {10, 10, 10, 10, 10, 10, 10, 10};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Verdanturf_Door_BattleTent,                   DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_BattleTent, sDoorAnimPalettes_BattleTent},
