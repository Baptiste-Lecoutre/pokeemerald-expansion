...
#define VERSION_BANNER_LEFT_X 147//98
#define VERSION_BANNER_RIGHT_X (VERSION_BANNER_LEFT_X + 64)
#define VERSION_BANNER_Y 74
#define VERSION_BANNER_Y_GOAL 138 //66
...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/megaray_deoxys.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/megaray_deoxys.bin.lz");
...
static void StartPokemonLogoShine(u8 flashBg)
{
    ...
    case 0:
    case 2:
        spriteId = CreateSprite(&sPokemonLogoShineSpriteTemplate, 0, 130, 0); // 0,68
    ...
    case 1:
        ...
        spriteId = CreateSprite(&sPokemonLogoShineSpriteTemplate, -80, 130, 0); // -80,68
        gSprites[spriteId].callback = SpriteCB_PokemonLogoShine2;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_WINDOW;
        break;
    }
...
static void Task_TitleScreenPhase2(u8 taskId)
{
    ...
    else
    {
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1
                                    ...
                                    | DISPCNT_BG2_ON
                                    | DISPCNT_OBJ_ON);
        CreatePressStartBanner(START_BANNER_X-75, 147);
        CreateCopyrightBanner(START_BANNER_X-48, 157);
