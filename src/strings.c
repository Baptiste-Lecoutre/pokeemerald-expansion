...
const u8 gText_ZCrystals[] = _("Z-crysals");
...
const u8 gText_TrainerRadarDescription[] = _("Check the opposing trainers data.");
...
const u8 gText_TypeChartInverse[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Inverse");
const u8 gText_TypeChartNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Normal");
...
const u8 gText_MenuSave[] = _("Save {SELECT_BUTTON}");
...
const u8 gText_TeamPreviewSingleDoubleText2[] = _("{B_TRAINER2_CLASS} {B_TRAINER2_NAME}'s Party");
