...
{
    u8 i;
    u16 starter = GetStarterPokemon(VarGet(VAR_STARTER_MON),VarGet(VAR_STARTER_REGION));
...
static void ShowBattleFrontierTutorMoveDescription(u8 menu, u16 selection)
{
    ...
    if (menu == SCROLL_MULTI_BF_MOVE_TUTOR_1 || menu == SCROLL_MULTI_BF_MOVE_TUTOR_2 || ((menu >= SCROLL_MULTI_PC_TUTOR_SET_1) && (menu <= SCROLL_MULTI_PC_TUTOR_SET_7)))
    {
        ...
        {
            case SCROLL_MULTI_PC_TUTOR_SET_1:
                AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, FONT_NORMAL, sPokemonCenter_TutorMoveDescriptions1[selection], 0, 1, 0, NULL);
                break;
            case SCROLL_MULTI_PC_TUTOR_SET_2:
                AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, FONT_NORMAL, sPokemonCenter_TutorMoveDescriptions2[selection], 0, 1, 0, NULL);
                break;
            case SCROLL_MULTI_PC_TUTOR_SET_3:
                AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, FONT_NORMAL, sPokemonCenter_TutorMoveDescriptions3[selection], 0, 1, 0, NULL);
                break;
            case SCROLL_MULTI_PC_TUTOR_SET_4:
                AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, FONT_NORMAL, sPokemonCenter_TutorMoveDescriptions4[selection], 0, 1, 0, NULL);
                break;
            case SCROLL_MULTI_PC_TUTOR_SET_5:
                AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, FONT_NORMAL, sPokemonCenter_TutorMoveDescriptions5[selection], 0, 1, 0, NULL);
                break;
            case SCROLL_MULTI_PC_TUTOR_SET_6:
                AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, FONT_NORMAL, sPokemonCenter_TutorMoveDescriptions6[selection], 0, 1, 0, NULL);
                break;
            case SCROLL_MULTI_PC_TUTOR_SET_7:
                AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, FONT_NORMAL, sPokemonCenter_TutorMoveDescriptions7[selection], 0, 1, 0, NULL);
                break;
            case SCROLL_MULTI_BF_MOVE_TUTOR_2:
...
//    u8 i;
    ...
    switch (moveTutor)
    {
        case 0:
            ...
            gSpecialVar_0x8005 = sPokemonCenter_TutorMoves1[moveIndex];
            break;
        case 1:
            /*i = 0;
            do
            ...
            gSpecialVar_0x8005 = sPokemonCenter_TutorMoves2[moveIndex];
            break;
        case 2:
            /*i = 0;
            do
            ...
            gSpecialVar_0x8005 = sPokemonCenter_TutorMoves3[moveIndex];
            break;
        case 3:
            /*i = 0;
            do
            ...
            gSpecialVar_0x8005 = sPokemonCenter_TutorMoves4[moveIndex];
            break;
        case 4:
            /*i = 0;
            do
            ...
            gSpecialVar_0x8005 = sPokemonCenter_TutorMoves5[moveIndex];
            break;
        case 5:
            /*i = 0;
            do
            ...
            gSpecialVar_0x8005 = sPokemonCenter_TutorMoves6[moveIndex];
            break;
        case 6:
            /*i = 0;
            do
            ...
            gSpecialVar_0x8005 = sPokemonCenter_TutorMoves7[moveIndex];
            break;
    }
}
...
void BufferChosenMonIV(void)
{
    ...
    switch (statToRead)
    {
    case STAT_HP: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_HP_IV);
       break;
    case STAT_ATK: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_ATK_IV);
       break;
    case STAT_DEF: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_DEF_IV);
       break;
    case STAT_SPEED: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_SPEED_IV);
       break;
    case STAT_SPATK: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_SPATK_IV);
       break;
    case STAT_SPDEF: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_SPDEF_IV);
       break;
    }
}
...
void BufferChosenMonEV(void)
{
    ...
    switch (statToRead)
    {
    case STAT_HP: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_HP_EV);
       break;
    case STAT_ATK: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_ATK_EV);
       break;
    case STAT_DEF: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_DEF_EV);
       break;
    case STAT_SPEED: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_SPEED_EV);
       break;
    case STAT_SPATK: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_SPATK_EV);
       break;
    case STAT_SPDEF: gSpecialVar_0x8006 = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_SPDEF_EV);
       break;
    }
}
...
void BufferChosenMonAllEVs(void)
{
    ...
    for (i = 0; i < NUM_STATS; i++)
        EV[i] = GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_HP_EV + i);
...
void CheckChosenMonCanGainEVs (void)
{
    ...
    if ((sumEVs + increment) > MAX_TOTAL_EVS)
...
{
    FLAG_VISITED_RUSTBORO_CITY, FLAG_DELIVERED_STEVEN_LETTER, FLAG_VISITED_MAUVILLE_CITY, FLAG_VISITED_LAVARIDGE_TOWN,
