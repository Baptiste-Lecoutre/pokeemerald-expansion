...
static void UpdateBirchSpeechObjects(u8);
...
static void CB2_NewGameBirchSpeech_ReturnFromNamingScreen(void)
{
    ...
    gTasks[taskId].tBG1HOFS = -60;
    gTasks[taskId].tCostumeId = gSaveBlock2Ptr->costumeId;
    ScanlineEffect_Stop();
    ResetSpriteData();
    FreeAllSpritePalettes();
    ResetAllPicSprites();
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    brendanSpriteId = CreateTrainerSprite(maleTrainerPicId, 120, 60, 0, NULL);
    gSprites[brendanSpriteId].callback = SpriteCB_Null;
    gSprites[brendanSpriteId].invisible = TRUE;
    gSprites[brendanSpriteId].oam.priority = 0;
    gTasks[taskId].tBrendanSpriteId = brendanSpriteId;
    maySpriteId = CreateTrainerSprite(femaleTrainerPicId, 120, 60, 0, NULL);
...
static void UpdateBirchSpeechObjects(u8 taskId)
{
    u8 brendanSpriteId;
    u8 maySpriteId;
    u8 maleTrainerPicId = TRAINER_PIC_BRENDAN;
    ...
    brendanSpriteId = CreateTrainerSprite(maleTrainerPicId, DISPLAY_WIDTH, 60, 0, NULL);
    gSprites[brendanSpriteId].callback = SpriteCB_Null;
    gSprites[brendanSpriteId].invisible = TRUE;
    gSprites[brendanSpriteId].oam.priority = 0;
    gTasks[taskId].tBrendanSpriteId = brendanSpriteId;
    maySpriteId = CreateTrainerSprite(femaleTrainerPicId, DISPLAY_WIDTH, 60, 0, NULL);
    gSprites[maySpriteId].callback = SpriteCB_Null;
    gSprites[maySpriteId].invisible = TRUE;
    gSprites[maySpriteId].oam.priority = 0;
    gTasks[taskId].tMaySpriteId = maySpriteId;
...
static void RenderPlayerParty(void)
{
    ...
    for (i = 0; i < gPlayerPartyCount; i++)
    {
        ...
        id = CreateMonIconNoPersonality(species, SpriteCallbackDummy, 26 * i + 80, 10, 0);
        iconsIDs[i] = id;
