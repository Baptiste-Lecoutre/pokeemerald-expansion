...
{
    /*[FRLG_COSTUME]               = {TRAINER_PIC_RED, TRAINER_PIC_LEAF},
    [RSE_COSTUME]           = {TRAINER_PIC_BRENDAN, TRAINER_PIC_MAY},
    [HGSS_COSTUME]             = {TRAINER_PIC_ETHAN, TRAINER_PIC_KRIS},
    [DPEARL_COSTUME]             = {TRAINER_PIC_LUCAS, TRAINER_PIC_DAWN},
    [PLATINUM_COSTUME]    = {TRAINER_PIC_LUCAS_PLATINUM, TRAINER_PIC_DAWN_PLATINUM},
    [LGPE_COSTUME]             = {TRAINER_PIC_CHASE, TRAINER_PIC_ELAINE},*/
    [GREEN_COSTUME] = {TRAINER_PIC_BRENDAN, TRAINER_PIC_MAY},
    [RED_COSTUME] = {TRAINER_PIC_BRENDAN_RED, TRAINER_PIC_MAY_RED},
    [BLUE_COSTUME] = {TRAINER_PIC_BRENDAN_BLUE, TRAINER_PIC_MAY_BLUE},
    [YELLOW_COSTUME] = {TRAINER_PIC_BRENDAN_YELLOW, TRAINER_PIC_MAY_YELLOW},
};
